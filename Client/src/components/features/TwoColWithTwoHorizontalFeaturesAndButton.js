...
export default ({
  ...
  primaryButtonText = "Visit Us",
  primaryButtonUrl = "https://gusec.edu.in/",
   ...
   * `icon` muEndless SupporVG component. See how BriefcaseIcon is imported above. For a full list of available icons, see Feather Icons.
   */
